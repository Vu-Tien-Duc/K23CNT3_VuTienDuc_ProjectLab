...
// giải thích: ->where('name','[A-Za-z]+'); khi name là chữ từ A-z thì web chạy nếu 'name' !=(Khác) A-z thì lổi
// A-z là chữ VD: ansmfslnpoagnienbwpi còn khi viết khác a-z như : 12314 thì chương trình báo lỗi
